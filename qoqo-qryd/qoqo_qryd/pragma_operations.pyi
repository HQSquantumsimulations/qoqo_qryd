...
"""
    ...
    def substitute_parameters(self, substitution_parameters: Dict[str, float]) -> PragmaChangeQRydLayout: 
        """
...
"""
    ...
    def substitute_parameters(self, substitution_parameters: Dict[str, float]) -> PragmaShiftQRydQubit: 
        """
Substitute the symbolic parameters in a clone of the PRAGMA operation according to the substitution_parameters input.
...
"""
    ...
    def substitute_parameters(self, substitution_parameters: Dict[str, float]) -> PragmaDeactivateQRydQubit: 
        """
Substitute the symbolic parameters in a clone of the PRAGMA operation according to the substitution_parameters input.
...
"""
    ...
    def substitute_parameters(self, substitution_parameters: Dict[str, float]) -> PragmaShiftQubitsTweezers: 
        """
Substitute the symbolic parameters in a clone of the PRAGMA operation according to the substitution_parameters input.
...
"""
    ...
    def substitute_parameters(self, substitution_parameters: Dict[str, float]) -> PragmaSwitchDeviceLayout: 
        """
Substitute the symbolic parameters in a clone of the PRAGMA operation according to the substitution_parameters input.
