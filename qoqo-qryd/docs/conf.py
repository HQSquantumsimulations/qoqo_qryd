...
try:
    with open('../qoqo_qryd/__version__.py') as f:
        lines = f.readlines()
...
latex_documents = [
    (master_doc, 'qoqo_qryd.tex', 'qoqo_qryd Documentation',
...
man_pages = [
    (master_doc, 'qoqo_qryd', 'qoqo_qryd Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qoqo_qryd', 'qoqo_qryd Documentation',
     author, 'qoqo_qryd', 'QRyd backend for qoqo quantum computing toolkit.',
     'Miscellaneous'),
]
